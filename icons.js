...
export class _ShoppingCart extends BaseIcon{
    constructor(){
        super();
...
export class _Plus extends BaseIcon{
    constructor(){
        super();
...
export class _Light extends BaseIcon{
    constructor(){
        super();

        this.shadowRoot.innerHTML+= `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
...
export class _Dark extends BaseIcon{
    constructor(){
        super();
